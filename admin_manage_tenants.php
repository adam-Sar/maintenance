                        ...
                        <div class="tenant-card">
                            <div class="tenant-info">
                                ...
                                <div class="tenant-details">
                                    <span class="tenant-detail-item">📧 <?php echo htmlspecialchars($req['tenant_email']); ?></span>
                                    <span class="tenant-detail-item">🏢 <?php echo htmlspecialchars($req['org_name']); ?></span>
                                    <span class="tenant-detail-item">🏠 Unit <?php echo htmlspecialchars($req['unit_number']); ?></span>
                                </div>
                            </div>
